...
const Services = () => {
  return (
    <ul
      className="min-h-72 lg:flex lg:flex-row lg:justify-center lg:gap-10 sm:flex sm:justify-center sm:gap-6 w-full flex flex-col items-center gap-10 bg-zinc-300 py-3"
      id="services"
    >
